...
if minsad == inf
    ...
    for i = ((h + 1)/2): (m - (h + 1)/2)
        for j = ((w + 1)/2):(n - (w + 1)/2)
            if (i~=(m+1)/2)&&(j ~=(n+1)/2 )
                dR(i, j)= sad1(MP((m+1)/2 - ((h -1)/2): (m+1)/2 + ((h -1)/2), (n+1)/2 - (w -1)/2 :  (n+1)/2 + (w -1)/2 ),Forinpantingarea((m+1)/2 - ((h -1)/2): (m+1)/2 + ((h -1)/2), (n+1)/2 - (w -1)/2 :  (n+1)/2 + (w -1)/2 ,1),MP(i - ((h -1)/2): i + ((h -1)/2), j - (w -1)/2 :  j + (w -1)/2 ),Forinpantingarea(i - ((h -1)/2): i + ((h -1)/2), j - (w -1)/2 :  j + (w -1)/2 ,1) );
                dB(i, j)= sad1(MP((m+1)/2 - ((h -1)/2): (m+1)/2 + ((h -1)/2), (n+1)/2 - (w -1)/2 :  (n+1)/2 + (w -1)/2 ),Forinpantingarea((m+1)/2 - ((h -1)/2): (m+1)/2 + ((h -1)/2), (n+1)/2 - (w -1)/2 :  (n+1)/2 + (w -1)/2 ,2),MP(i - ((h -1)/2): i + ((h -1)/2), j - (w -1)/2 :  j + (w -1)/2 ),Forinpantingarea(i - ((h -1)/2): i + ((h -1)/2), j - (w -1)/2 :  j + (w -1)/2 ,2) );
                dG(i, j)= sad1(MP((m+1)/2 - ((h -1)/2): (m+1)/2 + ((h -1)/2), (n+1)/2 - (w -1)/2 :  (n+1)/2 + (w -1)/2 ),Forinpantingarea((m+1)/2 - ((h -1)/2): (m+1)/2 + ((h -1)/2), (n+1)/2 - (w -1)/2 :  (n+1)/2 + (w -1)/2 ,3),MP(i - ((h -1)/2): i + ((h -1)/2), j - (w -1)/2 :  j + (w -1)/2 ),Forinpantingarea(i - ((h -1)/2): i + ((h -1)/2), j - (w -1)/2 :  j + (w -1)/2 ,3) );
                dD(i, j) = sad1(MP((m+1)/2 - ((h -1)/2): (m+1)/2 + ((h -1)/2), (n+1)/2 - (w -1)/2 :  (n+1)/2 + (w -1)/2 ),Forinpantingaread((m+1)/2 - ((h -1)/2): (m+1)/2 + ((h -1)/2), (n+1)/2 - (w -1)/2 :  (n+1)/2 + (w -1)/2 ),MP(i - ((h -1)/2): i + ((h -1)/2), j - (w -1)/2 :  j + (w -1)/2 ),Forinpantingaread(i - ((h -1)/2): i + ((h -1)/2), j - (w -1)/2 :  j + (w -1)/2 ) );
